...
export default function SwipeableTemporaryDrawer({ isOpenSidebar, toggleDrawer }) {
  ...
  const list = () => (
    ...
    >
      <Box sx={{ height: "60px", display: "flex", alignItems: 'center', padding: "10px 20px" }}>
      ...
      <List sx={{ borderTop: "1px solid #e9ecef" }}>
        {menuLinks.map((item, index) => (
          <ListItem sx={{
            ...
            >
              <ListItemIcon sx={{
                minWidth: 0, background: "#f8f9fa", transition: "all 0.3s", width: "36px", height: "36px", borderRadius: "6px", display: "flex", justifyContent: "center", alignItems: "center",
                "& .MuiSvgIcon-root": {
                  fontSize: "16px",
                  color: "#161c2d",
                  fontWeight: 500,
